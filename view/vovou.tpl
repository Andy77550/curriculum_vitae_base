...
<center>
	...
	<a href="{{ _p.web_plugin }}curriculum_vitae_base/experience_form.php" class="btn btn-primary">
		<span class="fa fa-arrow-left" aria-hidden="true"></span> {{ 'Retour'|get_lang }}
	</a>

	<a href="{{ _p.web_plugin }}curriculum_vitae_base/experience_hobbies.php?action=cancel&{{ {'id_user': xpPro.id_user}|url_encode() }}" class="btn btn-danger">
