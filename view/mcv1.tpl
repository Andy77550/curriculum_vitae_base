		...
		<div class="section">
            ...
            {% for xpForm in xpForm %}
                ...
                <div class="sec-droite" >
                    <p><span class="titre">&nbsp{{ xpForm.diplome }}</span><br/>&nbsp{{ xpForm.etablissement}}</p>
                </div>
		...
		<div class="section">
            ...
            {% for xpPro in xpPro %}
                <div class="sec-gauche">
                    <div id="exp-gauche">
                        <p>&nbsp{{ xpPro.date_begin}}&nbsp-&nbsp{{ xpPro.date_end}}</p>
                    </div>
                </div>
                <div class="sec-droite">
                    <p><span class="titre"> &nbsp{{ xpPro.title }}</span><br/>&nbsp{{ xpPro.description}}</p>
                </div>
